    ...
    if (fromDate && toDate) {
      if (key === "joinedFromWeb" || key === "joinedFromApp") {
        ...
        setCountData({
          ...countData,
          ...(key === "joinedFromApp" && {
            joinedFromApp: res.filter(
              (custData) => custData.lead_source === "APP"
            ).length,
          }),
          ...(key === "joinedFromWeb" && {
            joinedFromWeb: res.filter(
              (custData) => custData.lead_source !== "APP"
            ).length,
          }),
        });
  ...
  return (
    <section className="container-fluid">
      <div className="db_customer_detail_wrap">
        <div className="row">
          {/* Render CountDisplayCard components for various analytics */}
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <CountDisplayCard
              ...
              onClickDownload={() =>
                handleDownload(
                  "total_count",
                  dateRange.totalCustomers.from,
                  dateRange.totalCustomers.to
                )
              }
              onUpdateDateFilter={(val) =>
                handleDateFilter("totalCustomers", val)
              }
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <CountDisplayCard
              ...
              onClickDownload={() =>
                handleDownload(
                  "no_contacted",
                  dateRange.notContacted.from,
                  dateRange.notContacted.to
                )
              }
              onUpdateDateFilter={(val) =>
                handleDateFilter("notContacted", val)
              }
              selectedDateRange={selectedDayRange.notContacted}
              title={t("common:AnalyticsCustomer.NotContactedArtists")}
              reset={() => resetCalender("notContacted")}
            />
          </div>
          <div className="col-lg-3 col-md-6 col-sm-6">
            <CountDisplayCard
              ...
              onClickDownload={() =>
                handleDownload(
                  "customer_no_offer_completed",
                  dateRange.noCompletedOffer.from,
                  dateRange.noCompletedOffer.to
                )
              }
              onUpdateDateFilter={(val) =>
                handleDateFilter("noCompletedOffer", val)
              }
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <CountDisplayCard
              ...
              onClickDownload={() =>
                handleDownload(
                  "contacted_with_no_offer",
                  dateRange.contactedWithNoOffer.from,
                  dateRange.contactedWithNoOffer.to
                )
              }
              onUpdateDateFilter={(val) =>
                handleDateFilter("contactedWithNoOffer", val)
              }
        ...
        <div className="row">
          <div className="col-lg-3 col-md-6 col-sm-6">
            <CountDisplayCard
              ...
              onClickDownload={() =>
                handleDownload(
                  "deleted",
                  dateRange.deletedCustomers.from,
                  dateRange.deletedCustomers.to
                )
              }
              onUpdateDateFilter={(val) =>
                handleDateFilter("deletedCustomers", val)
              }
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <CountDisplayCard
              ...
              onClickDownload={() =>
                handleDownload(
                  "voucher_used_customer",
                  dateRange.voucherUserCustomers.from,
                  dateRange.voucherUserCustomers.to
                )
              }
              onUpdateDateFilter={(val) =>
                handleDateFilter("voucherUserCustomers", val)
              }
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <CountDisplayCard
              ...
              onClickDownload={() =>
                handleDownload(
                  "referral_used_customer",
                  dateRange.referralUsedCustomers.from,
                  dateRange.referralUsedCustomers.to
                )
              }
              onUpdateDateFilter={(val) =>
                handleDateFilter("referralUsedCustomers", val)
              }
