        ...
        <div className="db_card_body p_16">
            <div className="d_flex justify_space_between align_item_center pb_12 pr_35">
                <div>
                    ...
                    <p>
                        {
                            filteredDateRange && filteredDateRange.from && filteredDateRange.from
                            ?`${moment(filteredDateRange.from).format('DD MMM YYYY')} ${moment(filteredDateRange.to).format('DD MMM YYYY') !== moment(filteredDateRange.from).format('DD MMM YYYY')? `- ${moment(filteredDateRange.to).format('DD MMM YYYY')}`:''}`
                            :''
                        }
                    </p>
                </div>    
