...
export default function OrangeTwoRowBlock({mainTitle, img1, title1, content1, img2, title2, content2, bgColor}) {
  return (
    <section className="img_text_banner_box">
        ...
        <div className="col_full">
            <div className="img_text_box_wrapper">
                <div className={"text_box_wrap right pb_20 m_pr_0 m_pb_15"} style={{"backgroundColor":bgColor}}>                    
                        ...
                        <div className="text_box_content justify_content_start align_item_normal p_0 text_left w_100pc min_h_reset">
                            <div className="text_box_content_inner max_w_100pc d_flex flex_direction_row m_flex_direction_column">
                                <div className="d_flex flex_direction_column pr_40 m_pr_0 m_pb_35">
                                    ...
                                    <p className="custom_fs_16 custom_fs_m_16 color_gray_550 mb_0 mt_10 ">{content1}</p>
                                </div>
                                <div className="d_flex flex_direction_column pr_40 m_pr_0 m_pb_35">
                                    <div className="icon">                  
                                        <Image  
                                    ...
                                    <p className="  custom_fs_16  custom_fs_m_16 color_gray_550 mb_0 mt_10  ">{content2}</p>
                                </div>
