...
<div className="col_full">
    <div className="img_text_box_wrapper">
        <div className={"text_box_wrap right block_bg_green_100  pb_75 pt_75 mb_35 m_pt_25 m_pb_0"}>                    
                    ...
                    <div className="text_box_content_inner max_w_100pc">
                        <div className="d_flex flex_direction_column mb_65 m_mt_15 m_mb_45">
                         ...
                         <div className="d_flex flex_direction_column m_mb_45">
                            ...
                            <p className="custom_fs_16 custom_fs_m_16 color_gray_550 mb_0 mt_5 ">{content4}</p>
                        </div> 
                    </div>
                </div>
