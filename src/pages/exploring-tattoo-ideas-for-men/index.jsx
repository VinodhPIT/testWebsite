...
export default function TattooIdeasForMen() {
  ...
  const carosuelForMen = [
...

    {
      ...
      altTag: "Small Tattoo Ideas for Men",
    },
  ...
  const crossTattoo = [
    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/bc4c6538-7f5b-4e53-b71b-09d670a0b8fc`,
    },
    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/26135_20230818133129210-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/71ad5f69-2c05-4666-b44f-dce8d39a8c4d`,
    },
    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/17370_20230203132358438-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/107595cf-876b-4276-b575-c5b16bd3e2f0`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/26845_20230917203559564-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/88c8e50d-37a6-4f6f-a75e-1a06cfc6d145`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/3021_20220920181814962-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/4f42297e-2235-4973-89f1-abb7037f0c36`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/25550_20230722110433958-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/6adb96f5-a278-4990-b488-dd5df109211a`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/2634_20220914105959127-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/f6acd94a-4ab6-4501-9159-970cf3410952`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/28270_20231030203112946-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/0d04f9ad-d3bf-493a-ab56-b3e47d6c2e8b`,
    },
  ];
  ...
  const dragonTattoo = [
    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/10dd2046-58a2-4757-b71a-ff1214958af9`,
    },
    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/5413_20221013110844591-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/02837f63-18fc-47cf-b6cf-4cae325e5c55`,
    },

    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/86871d13-c075-48d1-8921-1063080470fe`,
    },

    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/11cf61d8-443a-4f62-a137-6bb50394289f`,
    },

    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/47fccec9-7997-4092-b7ea-9936644054e0`,
    },

    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/5c0386b8-9c4f-4b01-b4e2-812311f3e0ea`,
    },

    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/e4370a16-5bfe-4449-bea4-260059486f29`,
    },
  ...
  const eagleTattoo = [
    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/2826212b-d61f-47df-b8a3-74e48fee02b5`,
    },
    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/21298_20230308093735434-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/c48c9c99-ad42-4275-a8fc-799be9a08963`,
    },
    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/16233_20230126133354449-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/d4131861-9723-433d-9516-f4c386e10dc5`,
    },
    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/8130_20221104175103838-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/80ddfe46-c5ba-45d5-a90b-6ef43345276b`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/3239_20220921220006093-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/310031a7-c09d-4c70-a6c0-8e715fd4ab33`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/17322_20230203092103845-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/a18d1106-61ce-46a5-89a3-d5afab4ccc01`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/6251_20221021203013830-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/b628340e-b556-4081-ba2b-4d7b308b66a5`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/6355_20221023095249109-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/36c5339a-3183-4ba7-965e-924c04f5b588`,
    },
  ];
  ...
  const roseTattoo = [
    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/06f72262-a7e0-4efc-9ba0-8bbcb58acd83`,
    },
    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/4655_20221006175730757-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/7f05e7fa-c207-40a3-8317-a436c2471667`,
    },
    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/5110_20221011114420674-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/04439aa9-0acf-41dc-a16d-136328c65a7c`,
    },
    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/4306_20221001155133303-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/9759134b-3b0c-48fa-a149-dcac92bcf1f8`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/14804_20230112222439519-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/aad2a915-1b60-4c92-9f3f-4aca4ba7e8e7`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/12975_20221228101248952-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/b142600d-2e6c-4049-8591-d77231cb3170`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/6139_20221021094548634-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/19e7be11-fbb8-4354-aebc-a20816b18734`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/24532_20230501120026877-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/0f83c045-8bce-4aa5-bfd4-42540272bd4a`,
    },
  ];
  ...
  const trendingArtist = [
    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/artists/chrisharvey_bghfm1a3`,
    },
    {
      artistImage:
      ...
      city: "London",
      country: "United Kingdom",
      url: `${process.env.LIVE_URL}/${router.locale}/artists/southgatesgtattoo_x0xn3epc`,
    },
    {
      artistImage:
        "https://storage.googleapis.com/hllincd-bucket/profile/image/1012_a6338e0d-9888-4ca1-b6dc-06f911cd3361.jpg",
    ...
    },
    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/artists/nhong-niramit_oca540jq`,
    },
    {
      artistImage:
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`${process.env.LIVE_URL}/${router.locale}/explore/tattoos/bc4c6538-7f5b-4e53-b71b-09d670a0b8fc`}
        />
        <meta
          property="og:image"
      ...
      <div>
        ...
        <FullWidthcarosuel
          ...
          buttonName="Explore more tattoos"
          datas={roseTattoo}
          keyword={`/${router.locale}/explore/tattoos?keyword=Rose`}
          altTag="Rose Tattoo"
        />
        ...
        <SideBySideContentWithImage
          ...
          alt1="Expressing Individuality Regardless of Tattoo Size"
          alt2="Honoring Tradition with Tribal Tattoos"
        />
        ...
        <OrangeTwoRowBlock
          ...
          bgColor="#FFD5C0"
          imgAlt1="Image Gallery"
          imgAlt2="Connecting Through Body Art"
        />
