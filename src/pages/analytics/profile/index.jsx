          ...
          <div className="row">
            <div className="col-lg-12 col-md-12">
              <div class="user_profile_block">
                ...
                <button type="button" className="btn_secondary block_bg_green_800">Public</button>
                </div>
              </div>                          
            </div>              
          </div>          
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12">
              <Tabs className={"db_tab_block"}>
                ...
                <TabPanel>
                  <div class="profile_info_col">
                    <div class="profile_info_head">
                      ...
                      <ul class="profile_status_block">
                        <li>
                          <h6 class="profile_status_label">Profile status</h6>
                          <span class="profile_status_indicator">Public</span>
                        </li>
                        <li>
                          <h6 class="profile_status_label">Profile public date:</h6>
                          <span class="profile_status_date">14/02/2024</span>
                        </li>
                      </ul>
                    </div>
                ...
                <TabPanel>
                  Your component  need to  come here
                </TabPanel>                  
