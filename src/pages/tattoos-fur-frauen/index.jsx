  ...
  const floweTattoos = [
    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/a1d1cc8d-a1d7-41b9-8eb4-6e58f424bd8d`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/12301_20221218153728182-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/1e8f3636-49ed-43a0-b6a2-d591e5fa5428`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/19408_20230215200910408-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/021b10eb-7d3d-4c35-b29c-2b03ae9c0a89`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/5856_20221018160121840-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/073846e5-ebab-4134-873b-53f5efbd2cbf`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/19410_20230215200912069-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/55406ad4-6437-4c8c-9ce9-4300847fdfb5`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/3161_20220921165323756-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/d3b87c6a-066e-423b-b07e-8f4bb031dc4b`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/4041_20220929063719022-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/fa69ed9a-755f-461c-bc48-13371981b4b3`,
    },
  ];
  ...
  const  rosenTattos=[
    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/4bab0757-ead6-4924-8969-ace472d4e636`,
    },
    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/2181_20220901165222178-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/d41d185e-7952-49c2-9998-6a00efa4eb32`,
    },
    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/29251_20231113025339771-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/865f541e-b3a0-4214-bad6-ee409032bc61`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/23798_20230411211346424-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/8238ce6f-c34e-48a4-a31c-481ec603b823`,
    },
    {
      image:
...

    {
      ...
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/03b6ef98-6cb3-4f9c-9cd2-2cae2da24e04`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/7239_20221027125241846-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/0184995e-d820-4ad4-bef6-3b6472709086`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/4343_20221001230226996-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/e01601b2-cac2-4cfb-978a-537c2eec1203`,
    },

    {
      image:
        "https://storage.googleapis.com/hllincd-bucket/profile/image_medium/20716_20230228081436105-medium.jpg",
      url: `${process.env.LIVE_URL}/${router.locale}/explore/tattoos/61e536ad-9327-4eb0-a51c-6799903f96c5`,
    },
  ];
  ...
  return (
    <div>
      ...
      <SideBySideContentWithImage
        ...
        alt1="Hautpflege nach dem Stechen"
        alt2="Emotionale Bedeutung: Ein Tattoo mit Herz und Seele"
      />
...
Deine Haut ist die Leinwand, und wir stehen bereit, dir bei der Gestaltung deines einzigartigen Meisterwerks zu helfen. Finde Inspiration, entdecke die Symbolik hinter den Motiven und lass dich von der kreativen Vielfalt der weiblichen Tattoo-Kunst begeistern. Dein Weg zu einem einzigartigen Ausdruck deiner Persönlichkeit beginnt hier. Wir freuen uns darauf, Teil deiner faszinierenden Tattoo-Reise zu sein."
        ...
        altTag1="Cover-up Tattoos: Eine Neue Geschichte Schreiben"
        altTag2="Tattoo Motive: Vielfalt und Individualität"
        altTag3="Fazit: Deine Reise in die Welt der Weiblichen Tattoos"
        bgColor="#fff"
      />
